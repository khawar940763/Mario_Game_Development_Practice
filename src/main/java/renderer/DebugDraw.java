...
public class DebugDraw {
    ...
    public static void adBox2D(Vector2f center , Vector2f dimensions , float rotation ){
        // TODO: Add constants for common colors
        adBox2D(center , dimensions , rotation , new Vector3f(0 , 1 , 0) , 1);
    }

    public static void adBox2D(Vector2f center , Vector2f dimensions , float rotation , Vector3f color ){
        adBox2D(center , dimensions , rotation ,new Vector3f(0 , 1 , 0), 1);

    }
    public static void adBox2D(Vector2f center , Vector2f dimensions , float rotation , Vector3f color , int lifetime){
