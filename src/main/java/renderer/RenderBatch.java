...
public class RenderBatch {
    ...
    public void start(){
        ...
        glVertexAttribPointer(0 , POS_SIZE , GL_FLOAT, false, VERTEX_SIZE_FLOAT ,  POS_OFFSET);
        glEnableVertexAttribArray(0);

        glVertexAttribPointer(1 , COLOR_SIZE , GL_FLOAT, false, VERTEX_SIZE_FLOAT ,  COLOR_OFFSET);
        glEnableVertexAttribArray(1);

        glVertexAttribPointer(2 , TEX_COORDS_SIZE , GL_FLOAT, false, VERTEX_SIZE_FLOAT ,  TEX_COORDS_OFFSET);
    ...
    public void render(){
        ...
        for(int i =  0 ; i < textures.size() ; i++){
            textures.get(i).unBind();              // Maybe an error
        }
    ...
    private void loadElementIndices(int[] elements , int index){
        ...
        // e.g  3 , 2 , 0 , 0 , 2 , 1     or     7 , 6 , 4 ,4 , 6 , 5
